module.exports = {
  components: {
    ...
    'advt.24hrs.flowers.stop.KeyWordChecker': require('./components/stopwords/KeyWordChecker'),
    'advt.24hrs.flowers.dialogflow.StateTracker': require('./components/dialogflow/StateTracker')
  }
};