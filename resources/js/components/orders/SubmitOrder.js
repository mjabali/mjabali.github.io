...
module.exports = {
    ...
    metadata: () => ({
        ...
        "supportedActions": ["OrderSubmitted, SubmitError"]
    }),
    ...
    invoke: (conversation, done) => {
        ...
        //optional fields
        const discountPercent = Number(conversation.properties().discountPercent ? conversation.properties().discountPercent : 0);
        ...
        if (conversation.oracleMobile != null) {
            ...
            conversation.oracleMobile.storage.storeById("advt24hrsflowersOrders", orderId, JSON.parse(JSON.stringify(order)), {
                ...
                function (result) {
                    ...
                    conversation.transition("OrderSubmitted");          
                    done();          
                },
                function (error) {
                    ...
                    conversation.transition("SubmitError");
